...
//     console.log({ bytesRead }, { buffer: readResult.buffer[16380] });

//     if (bytesRead != 16384) {
//       const indexOfNotFilled = readResult.buffer.indexOf(0);
//       console.log(indexOfNotFilled, readResult.buffer.length);
//       const newBuffer = Buffer.alloc(indexOfNotFilled);
//       readResult.buffer.copy(newBuffer, 0, 0, 16384);
//       destFile.write(newBuffer);
//     } else destFile.write(readResult.buffer);
//   }
